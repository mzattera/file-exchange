...
public class Agent {
	...
	public Agent(@NonNull String id, @NonNull String description, @NonNull List<? extends Tool> tools) {
		this.client = OpenAIOkHttpClient.builder().fromEnv().maxRetries(10).timeout(Duration.ofMinutes(10)).build();
		this.id = id;
